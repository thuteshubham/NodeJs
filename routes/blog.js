...
let setRouter = (app) => {
    ...
    app.get(baseUrl+'/all',auth.isAuthenticated,auth.isAuthenticated,blogController.getAllBlog);
    ...
    app.get(baseUrl+'/view/:blogId',auth.isAuthenticated,auth.isAuthenticated,blogController.viewByBlogId);
